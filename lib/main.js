...
var init = exports.init = function(host, options) {
    ...
    var crumbresp = requestsync('GET', build_url(CRUMB));
    console.log(crumbresp);
    var crumbobj = JSON.parse(crumbresp.getBody());
    var crumb = crumbobj.crumb;
    var crumbRequestField = crumbobj.crumbRequestField;
    var headeroptions = {}
    headeroptions.headers = { [crumbRequestField]: crumb }
    request = request.defaults(headeroptions);
